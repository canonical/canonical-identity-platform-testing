...
export const model = {
  ...
  upstreamFindings: [
    "OBSERVED 2026-08-31, login-ui:stable (compose): the device-code page collapses the BFF's precise rejection to a generic error. PUT /api/device answers NOT_FOUND_ERROR_DESC 'The user_code provided is either invalid, expired or already used.' (canonical/identity-platform-login-ui@197703c9 pkg/device/handlers.go:22), but /ui/device_code renders only 'Something went wrong, please try again' — the S-8 message-collapse class. Covered: device-code-invalid-rejected pins the visible-error behaviour, not the wording.",
